...
timeout 1 > NUL
java DatabaseClient -gateway localhost:9002 -operation gc
java DatabaseClient -gateway localhost:9001 -operation gc
java DatabaseClient -gateway localhost:9002 -operation gc
java DatabaseClient -gateway localhost:9000 -operation gc
